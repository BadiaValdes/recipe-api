...
urlpatterns = [
    ...
    re_path('recipe/getAll/(?P<userid>[0-9a-f]{32})/', recipe_api.RecipeList.as_view(), name="recipe_user"),
    path('recipe/detail/<slug:slug>/', recipe_api.RecipeDetail.as_view(), name="recipe_image"),
